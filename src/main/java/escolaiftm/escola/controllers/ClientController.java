...
public class ClientController {
    ...
    ClientService service;
      /*public List<Cliente> findall() {
        ...
        Cliente cliente1 = new Cliente(2,"Jose","15389504932",12000.00 ,Instant.parse("1978-10-09T04:30:00.00Z"),2 );
        Cliente cliente2 = new Cliente(3,"Jose","15389504935",12000.00 ,Instant.parse("1977-10-09T04:30:00.00Z"),2 );
   ...
   @GetMapping("/{id}")
    ...
    @GetMapping("/Children/{children}")
    public ResponseEntity <List<Cliente>> findByChildrenGreaterThan(@PathVariable int children){
        List<Cliente> clients = service.findByChildrenGreaterThan(children);
